...
int main(int argc, char** argv)
{
    Input input1;
    cin >> input1;
    cout << "You have entered " << argc << " equation:" << "\n";
    for (int i = 0; i < argc; ++i)
        cout << argv[i] << "\n";
    input1.Result();
    cin.get();

    unsigned short optionSelected = 0;
    bool quit = false;
    while (quit == false)
    {
        do
        {
            std::cout << "Do you want to input the equation from a text file or write it?\n"
                << " 1) I would like to write the equation myself\n"
                << " 2) Input the equation from the text file \n"
                << " 3) I would like to exit the application\n"
                << ": ";
        ...
        case 2:
        {
            ...
            quit = true;
            Input input3;
            ifstream g("Equation.txt", ios::in);
            if (g.is_open())
            {
                g >> input3;
                input3.Result();
            ...
            //input3.Result();
            f << input3 << endl;
            cout << endl << "The object has been written in the text file!" << endl;
            f.close();
            break; }
        case 3:
            std::cout << "Exit....\n";
    ...
    input4.Result();
    cin.get();
    input4.serializare("binaryFile.bin");
    input4.deserializare("binaryFile.bin");


    unsigned short optionSelected1 = 0;
    bool quit1 = false;
    while (quit1 == false)
    {
        do
        {
            std::cout << "Do you want to input the equation from a text file or write it?\n"
                ...
                << " 3) I would like to exit the application\n"
                << ": ";
            std::cin >> optionSelected1;
            std::cout << "\n";
        } while (optionSelected1 > 2);
    ...
    unsigned short optionSelected2 = 0;
    bool quit2 = false;
    while (quit2 == false)
    {
        do
        {
            std::cout << "Do you want to input the equation from a text file or write it?\n"
                ...
                << " 3) I would like to exit the application\n"
                << ": ";
            std::cin >> optionSelected2;
            std::cout << "\n";
        } while (optionSelected2 > 2);
